...
var RedXSvg = ({ height, width, viewBox }) => /* @__PURE__ */ jsxs2("svg", { xmlns: "http://www.w3.org/2000/svg", width: width || "32", height: height || "32", viewBox: viewBox || "0 0 32 32", fill: "none", children: [
  /* @__PURE__ */ jsx4(
    "path",
    {
...
var GreenVSvg = ({ height, width, viewBox }) => /* @__PURE__ */ jsxs2("svg", { xmlns: "http://www.w3.org/2000/svg", width: width || "32", height: height || "32", viewBox: viewBox || "0 0 32 32", fill: "none", children: [
  /* @__PURE__ */ jsx4(
    "path",
    {
...
var useFilter = ({
  ...
  const [filterPopupsDisplay, setFilterPopupsDisplay] = useState("");
...
var TableProvider = (props) => {
  ...
  const [dataToRender, setDataToRender] = useState2(data);
  ...
  return /* @__PURE__ */ jsx7(TableContext.Provider, { value: providerValues, children: /* @__PURE__ */ jsx7("div", { className: `flex flex-col gap-2 ${containerClassName}`, style: containerStyle, children: props.children }) });
};
var Table = (props) => {
  const {
    containerStyle = {},
  ...
  return /* @__PURE__ */ jsxs5(TableProvider, { ...props, children: [
    /* @__PURE__ */ jsxs5("div", { className: "flex justify-start gap-2 ", children: [
      includeSearch && /* @__PURE__ */ jsx7(Search, { render: false }),
    ...
    sumColumns && /* @__PURE__ */ jsx7(Summary, { render: false })
  ] });
};
...
var InputContainer = ({
  ...
  return /* @__PURE__ */ jsxs6("div", { className: `center ${containerClassName}`, children: [
    /* @__PURE__ */ jsxs6("label", { className: `text-start w-[30%] ${labelClassName}`, htmlFor: name, children: [
      labelContent,
      " :"
    ] }),
    /* @__PURE__ */ jsx8(
...
var SelectContainer = ({
  ...
  const [selectedValue, setSelectedValue] = useState3(defaultValue || options[0]?.value || "");
  ...
  return /* @__PURE__ */ jsxs6("div", { className: `center ${containerClassName}`, children: [
    ...
    /* @__PURE__ */ jsxs6("div", { className: `w-[70%] relative ${elementClassName}`, onClick: () => setIsOpen(!isOpen), children: [
      /* @__PURE__ */ jsx8("div", { className: `border-b-[1px] border-black max-h-6 cursor-pointer ${elementClassName}`, children: options?.find((opt) => opt.value === selectedValue)?.label || selectedValue }),
      isOpen ? /* @__PURE__ */ jsx8("i", { className: "fa-light fa-chevron-up absolute top-[1px] left-1 cursor-pointer" }) : /* @__PURE__ */ jsx8("i", { className: "fa-light fa-chevron-down absolute top-[1px] left-1 cursor-pointer" }),
      isOpen && /* @__PURE__ */ jsx8("div", { className: "absolute w-full bg-white border border-gray-300 max-h-32 overflow-y-auto z-10", children: options.map((option) => /* @__PURE__ */ jsx8(
        "div",
        {
      ...
      /* @__PURE__ */ jsx8("input", { value: selectedValue, type: "hidden", name, required })
    ] })
  ] });
};
var ModularForm = ({
  ...
  return /* @__PURE__ */ jsxs6("form", { onSubmit, style: { direction }, className: `w-[350px] px-5 py-5 flex flex-col gap-5 ${formClassName}`, children: [
    /* @__PURE__ */ jsx8("div", { className: `border-b-2 border-[#547f22] pb-2 text-start font-bold text-[20px] ${headerClassName}`, children: headerContent }),
    elements.map((element, index) => {
      switch (element.type) {
        case "input":
          return /* @__PURE__ */ jsx8(InputContainer, { ...element }, index);
        case "select":
          return /* @__PURE__ */ jsx8(SelectContainer, { ...element }, index);
        default:
          return null;
      }
    }),
    /* @__PURE__ */ jsxs6("div", { className: "flex justify-between w-full", children: [
      /* @__PURE__ */ jsx8("div", { title: errorMsg, className: "text-[#f22] text-[18px] max-w-[80%] ellipsis", children: errorMsg }),
      /* @__PURE__ */ jsx8("button", { disabled: isLoading, className: "bg-[#547f22] px-3 py-1 rounded-lg text-white min-w-20", type: "submit", children: isLoading ? /* @__PURE__ */ jsx8(Loader, { size: 25, color: "#fff" }) : buttonContent })
    ] })
  ] });
};
var ConfirmForm = ({ onV, onX, headline = "", direction = "rtl" }) => {
  ...
  return /* @__PURE__ */ jsxs6("div", { style: { direction, padding: "30px" }, className: "full col gap-2", children: [
    /* @__PURE__ */ jsx8("div", { className: "text-lg font-bold", children: headline }),
    /* @__PURE__ */ jsxs6("div", { className: "center gap-2 ", children: [
      /* @__PURE__ */ jsxs6("button", { onClick: onDenied, children: [
        " ",
        /* @__PURE__ */ jsx8(RedXSvg, {}),
        " "
      ] }),
      /* @__PURE__ */ jsxs6("button", { onClick: onConfirm, children: [
        " ",
...
var DatePicker = ({
  ...
  return /* @__PURE__ */ jsxs6("form", { style: { direction }, onSubmit, className: `w-full h-10 flex justify-start gap-3 items-center ${formClassName}`, children: [
    /* @__PURE__ */ jsxs6("label", { className: `center text-[14px] relative gap-2 ${labelsClassName}`, htmlFor: "from", children: [
      fromText,
      /* @__PURE__ */ jsx8(
        "input",
        {
    ...
    /* @__PURE__ */ jsxs6("label", { className: `center text-[14px] relative gap-2 ${labelsClassName}`, htmlFor: "to", children: [
      toText,
      /* @__PURE__ */ jsx8(
        "input",
        {
    ...
    /* @__PURE__ */ jsx8(
      "button",
      {
        ...
        type: "submit",
        children: isLoading ? /* @__PURE__ */ jsx8(Loader, { className: "pt-[2px]", size: 20, color: "#fff" }) : buttonText
      }
    )
  ] });
};
