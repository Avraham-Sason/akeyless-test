...
import { Firestore, Timestamp, DocumentSnapshot, DocumentData, QueryDocumentSnapshot, WhereFilterOp, CollectionReference } from 'firebase/firestore';
...
declare const simpleExtractData: (doc: DocumentSnapshot<DocumentData> | QueryDocumentSnapshot<any, DocumentData>) => any;
...
declare const get_document_by_id: (collection_path: string, doc_id: string) => Promise<any>;
...
declare const query_documents: (collection_path: string, field_name: string, operator: WhereFilterOp, value: any) => Promise<any[]>;
interface WhereCondition {
    field_name: string;
    operator: WhereFilterOp;
    value: any;
}
declare const query_documents_by_conditions: (collection_path: string, where_conditions: WhereCondition[]) => Promise<any[]>;
declare const query_document_by_conditions: (collection_path: string, where_conditions: WhereCondition[]) => Promise<any>;

declare const calculateBearing: (startLat: number, startLng: number, endLat: number, endLng: number) => number;
